...
/*****/
void DirichletConductivityDomainBC::setValue(Real a_value)
{
...
/*****/
void
DirichletConductivityDomainBC::setFunction(RefCountedPtr<BaseBCValue> a_func)
{
  m_value = 12345.6789;
  m_func = a_func;
...
/*****/
void DirichletConductivityDomainBC::getFaceFlux(BaseFab<Real>&        a_faceFlux,
...
/******/
// defining the BC factory below
/******/
DirichletConductivityDomainBCFactory::DirichletConductivityDomainBCFactory()
...
/******/
void DirichletConductivityDomainBCFactory::setValue(Real a_value)
{
  m_value = a_value;
  m_func = RefCountedPtr<BaseBCValue>();
...
/******/
void DirichletConductivityDomainBCFactory::setFunction(RefCountedPtr<BaseBCValue> a_func)
{
  m_value = 12345.6789;
  m_func = a_func;
