         ...
         bool                        a_homogeneousPhysBC)
{
  ...
  //checkLevel(a_residual, string("residual "));
}
...
#ifdef CH_USE_PETSC
  Mat petsc_mat;
  ierr = MatCreateMPIAIJ(PETSC_COMM_WORLD,data,data,PETSC_DECIDE,PETSC_DECIDE,
...
//      bool stopHere = false;
//      if (dblBox.contains(IntVect(26, 1)))
//        {
//          stopHere = true;
//        }
      CH_START(t2);
  ...
  //checkLevel(a_opPhi, string("applyOpNoCFBCs"));
}
