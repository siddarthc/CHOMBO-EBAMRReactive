...
void
EBConductivityOp::
resetBCoefficient(RefCountedPtr<LevelData<EBFluxFAB> >&        a_bcoef,
                  RefCountedPtr<LevelData<BaseIVFAB<Real> > >& a_bcoIrreg)
{
  // added for multiComponent diffussion stuff
  // please call this only if you know what you are doing
  m_bcoef = a_bcoef;
  m_bcoIrreg = a_bcoIrreg;
  defineStencils(); //only for safety reasons.. shouldn't matter if you know what you are doing.. irony!!
}
//-----------------------------------------------------------------------
void
EBConductivityOp::
     ...
     int                         a_ord)
{
  ...
  //  pout() << endl << "EBConductivityOp::norm: res =" << endl;
