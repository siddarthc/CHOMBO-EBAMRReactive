...
void
CoarseAverageCodim::average(const LevelData<CodimBox>& a_fineData)
{
...
void
CoarseAverageCodim::averageHarmonic(const LevelData<CodimBox>& a_fineData)
{
...
void
CoarseAverageCodim::sum(const LevelData<CodimBox>& a_fineData,
...
void
CoarseAverageCodim::copyTo(LevelData<CodimBox>& a_coarseData)
{
  ...
  // build a specialized Copier for LevelData<CodimBox>, but we're
...
void
CoarseAverageCodim::averageToCoarse(LevelData<CodimBox>&       a_coarseData,
                                    const LevelData<CodimBox>& a_fineData)
{
...
CoarseAverageCodim::averageToCoarseHarmonic(
  LevelData<CodimBox>&       a_coarseData,
  const LevelData<CodimBox>& a_fineData)
{
...
void
CoarseAverageCodim::computeAverages(LevelData<CodimBox>&       a_coarseData,
                                    const LevelData<CodimBox>& a_fineData,
                            ...
                            const int                  a_refFactor)
{
  ...
  for (dit.begin(); dit.ok(); ++dit)
    {
      CodimBox& coarsenedFine = m_coarsenedFineData[dit()];
      const CodimBox& fine = a_fineData[dit()];
...
void
CoarseAverageCodim::averageGridData(CodimBox&         a_coarsenedFine,
                                    const CodimBox&   a_fine,
                                    const AverageType a_averageType,
